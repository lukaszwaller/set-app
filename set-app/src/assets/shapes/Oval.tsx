...
interface OvalProps {
  ...
  fill: string;  // Füllfarbe
}

const Oval: React.FC<OvalProps> = ({ color, fill }) => {
  return (
    <svg className="w-14 h-8" version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="300.000000pt" height="171.000000pt" viewBox="0 0 300.000000 171.000000"
 preserveAspectRatio="xMidYMid meet">
<g transform="translate(0.000000,171.000000) scale(0.100000,-0.100000)"
fill={fill} stroke={color} strokeWidth={100}>
<path d="M740 1489 c-118 -18 -135 -22 -150 -34 -8 -7 -28 -15 -44 -19 -17 -4
